...
- [Give Claude Code Access to Pi-hole Logs and Diagnostics](/docs/pi-hole/claude-code-access/)
  - Grant read-only access to the query database and logs with POSIX ACLs, optionally under a dedicated unprivileged user. Available as a staged walkthrough or as a single self-contained page per setup.
