...
Want Claude Code to run checks like these for you? See [Give Claude Code Access to Pi-hole Logs and Diagnostics](/docs/pi-hole/claude-code-access/).
...
Active peers also show the LAN address they connected from, such as `direct 192.168.0.22:41641`, which is how you match a tailnet address back to a device you know by its LAN IP.
