...
1. In the Omada controller, go to **Device Config** > select your gateway > **DNS Proxy**.
1. Turn on **DNS Proxy**.
1. Under **Proxy Type**, select **DNS Override**.
1. Set **Primary DNS Server** to your Pi-hole's IP address, and optionally a **Secondary DNS Server** as a fallback.
