...
Already know which combination you want? Each one has a complete,
self-contained [one-pager](/docs/pi-hole/claude-code-access/one-pagers/)
covering every step for that setup, no tabs to click through.

<details>
<summary>Pick your one-pager</summary>
