...
:::tip[Already know you want a dedicated agent user, from a workstation, over SSH?]
Skip the tabs below and use the [complete single-page walkthrough](/docs/pi-hole/claude-code-access/over-ssh-dedicated-user/) instead.
:::
