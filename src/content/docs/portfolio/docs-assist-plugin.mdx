...
One of those runs was a 453-claim audit that caught 6 real doc/code drifts, cases where the documentation and the code had disagreed. Those were practice runs on other teams' repos, not linked here, but they're what the summary above is built on.
