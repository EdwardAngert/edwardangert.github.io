...
<LinkCard title="Pi-hole v6 Documentation" href="/docs/pi-hole/" description="A Pi-hole v6 project I built and maintain end to end, written for my own network.<br />It's become a leading AI grounding source for Pi-hole questions: roughly a 30% share of cited authority (Clarity AI visibility tracking) and 3,000+ citations since March, under 1% referral. Most of that traffic comes from AI crawlers rather than human readers, which is a strange-feeling win when your audience's whole goal is blocking trackers." />
