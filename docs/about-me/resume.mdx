...
Technical writer and Docs team manager of four direct reports across three time zones as part of the Learning Experience team at a fast-paced Series E SaaS platform for Drupal, WordPress, and static sites. Acted as equal parts team lead and hands-on technical writer in a Docs as Code approach to developer-facing technical documentation.

#### Pantheon Highlights

Documentation strategy and knowledge management:

- Developed a standard documentation process for features and releases.
...
Practicing Brazilian Jiu-Jitsu, cycling, bouldering, roller skating, taking things apart, finding ways to make things work, building solutions, exploring open source software, and helping my toddler climb (everything) safely.
